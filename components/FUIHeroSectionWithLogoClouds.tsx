...
export default function FUIHeroSectionWithLogoClouds() {
  ...
  return (
    <div className="relative w-full flex flex-col bg-primary-faintest">
      <nav className="relative items-center pt-5 px-4 mx-auto w-full sm:px-8 lg:flex md:space-x-6">
        <div className="flex justify-between items-center">
          <a href="/">
            <Image
              src="/Brand-manual-DigiMedic/Brand materials/DigiMedic-logo-long.svg"
              width={200}
              height={50}
              alt="DigiMedic logo"
            />
        ...
        >
          <div className="items-center space-y-5 md:flex md:space-x-6 md:space-y-0 md:ml-12">
            {navigation.map((item, idx) => (
              <li className="text-primary hover:text-primary-dark" key={idx}>
